...
constexpr auto SCALE_BIG_ENEMY_SHIP = 3;

constexpr auto BIG_ENEMY_SHIP_TIMING = 20 * 1000; // 20 seconds
...
SDL_Point big_enemy_ship_ref[BIG_ENEMY_SHIP_VERTEX_COUNT] = {
		{-20, 0},{-10, -10},{-7, -20},{7, -20},{10,-10},{20,0},{10, 10},{-10, 10},{-20,0}, {-10,0}, {10, 0}, {20,0}
};
