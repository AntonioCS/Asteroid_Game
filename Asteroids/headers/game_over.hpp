...
public:
	game_over(SDL_Renderer *renderer, const std::string &font_path, int font_size, const std::string &message, const SDL_Color &color)
	{
		title_texture = loadFont(renderer, font_path, font_size, "GAME OVER", color);
